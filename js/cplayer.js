! function(e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define("cplayer-umd", [], t) : "object" == typeof exports ? exports["cplayer-umd"] = t() : e["cplayer-umd"] = t()
}(this, function() {
    return function(e) {
        function t(i) {
        ...
        e.exports = n, n.EventEmitter = n, n.prototype._events = void 0, n.prototype._maxListeners = void 0, n.defaultMaxListeners = 10, n.prototype.setMaxListeners = function(e) {
            ...
            if (i(n)) switch (arguments.length) {
                ...
                for (l = Array.prototype.slice.call(arguments, 1), s = n.slice(), o = s.length, c = 0; c < o; c++) s[c].apply(this, l);
            return !0
            ...
            if (n = this._events[e], a = n.length, o = -1, n === t || i(n.listener) && n.listener === t) delete this._events[e], this._events.removeListener && this.emit("removeListener", e, t);
            else if (r(n)) {
                for (l = a; l-- > 0;)
            ...
            var m = {
                ...
                v = function(t) {
                    function n(t) {
                        ...
                        }, t = Object.assign({}, m, t), r.playmode = new f[t.playmode](a(t.playlist), t.point), r.view = new y(r, t), h.cplayerMediaSessionPlugin(r), e(function() {
                    ...
                    return r(n, t), l(n, [{
                        ...
                        value: function(e) {
                            ...
                            t("timeupdate", n.handleTimeUpdate), t("canplaythrough", n.handleCanPlayThrough), t("pause", n.handlePause), t("play", n.handlePlay), t("playing", n.handlePlaying), t("ended", n.handleEnded), t("loadeddata", n.handleLoadeddata)
                        }
                    }, {
                        ...
                        value: function() {
                            ...
                            e && ("video" === e.type ? "HTMLVideoElement" !== this.audioElementType && (void 0 !== this.audioElement && (this.removeEventEmitter(this.audioElement), this.audioElement.src = ""), this.audioElement = document.createElement("video"), this.audioElement instanceof HTMLVideoElement && (this.audioElementType = "HTMLVideoElement", this.audioElement.loop = !1, this.audioElement.autoplay = !1, this.audioElement.poster = e.poster, this.audioElement.setAttribute("playsinline", "true"), this.audioElement.setAttribute("webkit-playsinline", "true")), this.initializeEventEmitter(this.audioElement), this.emit("audioelementchange", this.audioElement)) : "HTMLAudioElement" !== this.audioElementType && (void 0 !== this.audioElement && (this.removeEventEmitter(this.audioElement), this.audioElement.src = ""), this.audioElement = new Audio, this.audioElementType = "HTMLAudioElement", this.audioElement.loop = !1, this.audioElement.autoplay = !1, this.initializeEventEmitter(this.audioElement), this.emit("audioelementchange", this.audioElement)), this.setVolume(this.volume), this.audioElement.src = this.nowplay.src, this.emit("openaudio", e), this.__paused || this.play())
                        }
                    }, {
                        key: "toggleMode",
                        value: function() {
                        ...
                        key: "setMode",
                        value: function(e) {
                            "string" == typeof e && this.playmodeName !== e && f[e] && (this.playmode = new f[e](this.playlist, this.nowplaypoint), this.playmodeName = e, this.eventHandlers.handlePlaymodeChange())
                        }
                    }, {
                        key: "getMode",
                        value: function() {
                        ...
                        value: function() {
                            var e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
                                t = this.isPlaying(),
                                n = void 0;
                            return (!t && this.playlist.length > 0 || e) && (n = this.audioElement.play()), this.__paused && (this.__paused = !1, this.emit("playstatechange", this.__paused), this.emit("play")), n
                        }
                    }, {
                        key: "pause",
                        value: function() {
                            var e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
                            (this.isPlaying() && this.playlist.length > 0 || e) && this.audioElement.pause(), this.__paused || (this.__paused = !0, this.emit("playstatechange", this.__paused), this.emit("pause"))
                        }
                    }, {
                        key: "to",
                        value: function(e) {
                        ...
                        key: "add",
                        value: function(e) {
                            e = a([e])[0], this.playmode.addMusic(e), this.eventHandlers.handlePlayListChange(), 1 === this.playlist.length && this.to(0)
                        }
                    }, {
                        key: "remove",
                        value: function(e) {
                        ...
                        key: "setVolume",
                        value: function(e) {
                            this._volume = parseFloat(e), this.audioElement && (this.audioElement.volume = Math.max(0, Math.min(1, this._volume))), this.emit("volumechange", this.audioElement.volume)
                        }
                    }, {
                        key: "destroy",
                        value: function() {
                            var e = this;
                            this.audioElement && (this.audioElement.src = null, this.audioElement.removeEventListener("timeupdate", this.eventHandlers.handleTimeUpdate), this.removeAllListeners()), this.view && this.view.destroy(), Object.getOwnPropertyNames(this).forEach(function(t) {
                                return delete e[t]
        ...
        function i(e) {
            "mediaSession" in navigator && (navigator.mediaSession.metadata = o(e.nowplay), navigator.mediaSession.setActionHandler("play", function() {
                return e.play()
        ...
        function l(e, t) {
            return (arguments.length > 2 && void 0 !== arguments[2] && arguments[2] ? a(e) : e) + (t ? '<span class="cp-lyric-text-sub">' + t + "</span>" : "")
        }

        function c(e) {
            return parseInt((e / 60).toString()).toString().padStart(2, "0") + ":" + parseInt((e % 60).toString()).toString().padStart(2, "0")
        }
        ...
        function u(e, t, n) {
            ...
            return i.innerHTML = t, e.parentNode.insertBefore(i, e), document.getElementById("cplayer-style") || document.body.appendChild(s(n)), i.firstChild
        }
        ...
        function h(e, t, n) {
            return e.innerHTML = t, console.log(n), document.getElementById("cplayer-style") || document.body.appendChild(s(n)), e.firstChild
        }
        var y = function() {
            function e(e, t) {
                for (var n = 0; n < t.length; n++) {
        ...
        var m = n(16),
            ...
            x = function(e) {
                function t(e, n) {
                    ...
                    return r.elementLinks = m.default(r.getElementLinks), r.dropDownMenuShowInfo = !0, r.__OldVolume = 1, r.__OldLyric = "", r.__OldTotalTime = 0, r.handlePlaylistchange = function() {
                        r.updatePlaylist()
                        ...
                        "video" !== e.type ? r.setPoster(e.poster || v) : r.setPoster("none"), r.setProgress(0, 0, 0), r.elementLinks.title.innerText = e.name, r.elementLinks.artist.innerText = e.artist || "", r.updateLyric(), r.updatePlaylist()
                        ...
                        if (r.removeVolumeControllerKeepShow(), 1 === e.buttons || 1 === e.which) {
                            var t = Math.max(0, Math.min(1, (e.clientX - r.elementLinks.volumeController.getBoundingClientRect().left) / r.elementLinks.volumeController.clientWidth));
                            r.player.setVolume(t), r.setVolume(t)
                        }
                    }, r.handleTouchVolumeController = function(e) {
                        r.removeVolumeControllerKeepShow();
                        var t = Math.max(0, Math.min(1, (e.targetTouches[0].clientX - r.elementLinks.volumeController.getBoundingClientRect().left) / r.elementLinks.volumeController.clientWidth));
                        r.player.setVolume(t), r.setVolume(t)
                ...
                return r(t, e), y(t, [{
                    ...
                    value: function(e, t, n) {
                        this.elementLinks.progressFill.style.width = 100 * e + "%", this.elementLinks.progressButton.style.right = 100 * (1 - e) + "%", this.elementLinks.progressCurrentTime.innerText = c(t), this.elementLinks.progressDuration.innerText = c(n)
                    }
                }, {
                    key: "setPoster",
                    value: function(e) {
                    ...
                    value: function() {
                        var e = this.elementLinks.dropDownMenu;
                        e.style.height = 2.08333 * this.player.playlist.length + "em", e.classList.remove("cp-drop-down-menu-info"), e.classList.add("cp-drop-down-menu-playlist"), this.dropDownMenuShowInfo = !1
                    }
                }, {
                    ...
                    value: function(e) {
                        ...
                        if (this.__OldLyric !== e || this.__OldTotalTime !== n) {
                            if (this.elementLinks.lyric.innerHTML = e, this.elementLinks.lyric.style.transition = "", this.elementLinks.lyric.style.transform = "", 0 !== n) {
                                ...
                                if (i > o) {
                                    var r = n - t,
                                        ...
                                        c = Math.min(.6 * l, r),
                                        s = r - l;
                                    this.elementLinks.lyric.style.transition = "transform " + s + "ms linear " + c + "ms", this.elementLinks.lyric.style.transform = "translateX(-" + a + "px)"
                                }
                            }
                    ...
                    value: function() {
                        ...
                        }), this.elementLinks.playlistItems = this.getPlayListLinks(), this.injectPlayListEventListener(), this.dropDownMenuShowInfo || (this.elementLinks.dropDownMenu.style.height = 2.08333 * this.player.playlist.length + "em")
                    }
                }, {
                    ...
                    value: function() {
                        this.elementLinks.button.play.addEventListener("click", this.handleClickPlayButton), this.elementLinks.button.prev.addEventListener("click", this.handleClickPrevButton), this.elementLinks.button.next.addEventListener("click", this.handleClickNextButton), this.elementLinks.button.volume.addEventListener("click", this.handleClickVolumeButton), this.elementLinks.button.list.addEventListener("click", this.handleClickListButton), this.elementLinks.button.mode.addEventListener("click", this.handleClickModeButton), this.elementLinks.volumeController.addEventListener("mousemove", this.handleMouseVolumeController), this.elementLinks.volumeController.addEventListener("mousedown", this.handleMouseVolumeController), this.elementLinks.volumeController.addEventListener("touchmove", this.handleTouchVolumeController, {
                            passive: !0
                        }), this.elementLinks.progress.addEventListener("mousemove", this.handleMouseProgress), this.elementLinks.progress.addEventListener("mousedown", this.handleMouseProgress), this.elementLinks.progress.addEventListener("touchmove", this.handleTouchProgress, {
                            passive: !0
                        }), this.player.addListener("playstatechange", this.handlePlayStateChange), this.player.addListener("timeupdate", this.handleTimeUpdate), this.player.addListener("openaudio", this.handleOpenAudio), this.player.addListener("volumechange", this.handleVolumeChange), this.player.addListener("playmodechange", this.handleModeChange), this.player.addListener("playlistchange", this.handlePlaylistchange), this.player.addListener("audioelementchange", this.handleAudioElementChange), this.injectPlayListEventListener()
                    }
                }, {
                    key: "updateLyric",
                    value: function() {
                        ...
                        if (this.player.nowplay.lyric && "string" != typeof this.player.nowplay.lyric && this.player.played) {
                            ...
                            if (t) {
                                var i = void 0;
                                if (this.player.nowplay.sublyric && "string" != typeof this.player.nowplay.sublyric && (i = this.player.nowplay.sublyric.getLyric(1e3 * e)), n) {
                                    var o = n.time - t.time,
                                        r = 1e3 * e - t.time;
